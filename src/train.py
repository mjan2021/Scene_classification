...
if __name__ == '__main__':
    ...
    data_dir = '../data/AID/'
    dataset = SceneClassification(data_dir, '../data/train.csv', transform=None)
    dataset_size = len(dataset)
    test_dataset = SceneClassification(data_dir, '../data/test.csv', transform=None)
...
#                                        'test': test_acc_epoch}, step)
        ...
        np.save(f'../output_files/{model._get_name()}_Fold{fold}.npy', cf_matrix)
